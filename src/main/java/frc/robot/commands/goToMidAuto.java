 ...
 */
public class goToMidAuto extends SequentialCommandGroup {
  public goToMidAuto( RobotContainer robotContainer,
      CommandSwerveDrivetrain drivetrain,
      shooterNeoVortex shooterN,
      Shooter shooterK,
      intakeForNow intake,
    ...
    addCommands(
        ...
        new ParallelCommandGroup( new lowerIntake(intake).withTimeout(5), new SetSlowDriveMode(robotContainer).withTimeout(3),
            new PathPlannerAuto("goToMidAuto"),
